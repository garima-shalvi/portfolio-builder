...
if (!defined('VIA_P')) {
    ...
    $ownerCheck = $conn->prepare("SELECT id FROM portfolios WHERE id=? AND user_id=?");
    $ownerCheck->bind_param("ii", $portfolio_id, $_SESSION['auth_id']);
    $ownerCheck->execute();

    if (!$ownerCheck->get_result()->fetch_assoc()) {
...
height: 2px;
width: 100%;
background: linear-gradient(90deg,transparent,#00e0ff,#ffaedb,transparent);
...
<section class="hero">
<div class="hero-left">
<h1>Hi! 👋<br/><span>Welcome</span> to my portfolio,<br/>I am <span><?= e($user['name']) ?></span></h1>
...
<div class="info" id="phone-info">📞 <?= e($user['phone']) ?></div>
</div>
...
<div class="info" id="address-info">🏠 <?= e($user['address']) ?></div>
</div>

<?php if (!empty($user['resume'])): ?>
<a class="download-btn" href="<?= e($user['resume']) ?>" download>
...
<img src="<?= e($user['photo']) ?>">
<div class="links">
<a href="mailto:<?= e($user['email']) ?>"><i class="fa-solid fa-envelope"></i></a>
<a href="<?= e($user['github']) ?>" target="_blank" rel="noopener noreferrer"><i class="fa-brands fa-github"></i></a>
<a href="<?= e($user['linkedin']) ?>" target="_blank" rel="noopener noreferrer"><i class="fa-brands fa-linkedin-in"></i></a>
</div>
</div>
</section>
...
<div class="skill-card neon"><?= e($s) ?></div>
<?php } ?>
</div>
</section>
...
<p><i class="fa-solid fa-file-lines"></i><?= e($p['description']) ?></p>
<p><i class="fa-solid fa-code"></i><strong>Tech Stack:</strong> <?= e($p['tech_stack']) ?></p>
<?php if(!empty($p['project_link'])){ ?>
<a href="<?= e($p['project_link']) ?>" target="_blank" rel="noopener noreferrer" class="project-link">
...
<h3><?= e($ex['role']) ?></h3>
<span class="company"><?= e($ex['company']) ?></span>
<span class="duration"><?= e($ex['duration']) ?></span>
...
<h3><?= e($e['degree']) ?></h3>
<span class="institute"><?= e($e['institute']) ?></span>
<span class="duration"><?= e($e['duration']) ?></span>
<p>Score: <?= e($e['score']) ?></p>
</div>
<?php } ?>
</div>
...
<div class="cert-card">
<h3><?= e($c['certificate_name']) ?></h3>
<a href="<?= e($c['certificate_file']) ?>" target="_blank" rel="noopener noreferrer">
<img src="<?= e($c['certificate_file']) ?>">
</a>
</div>
<?php } ?>
</div>

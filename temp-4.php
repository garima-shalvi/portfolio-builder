...
inset:-3px;
border-radius:15px;
background:linear-gradient(120deg,transparent 20%,transparent 40%,white 50%,transparent 60%,transparent 80%);
...
border-color:cyan;
box-shadow:0 0 10px cyan,0 0 20px rgba(0,255,255,0.5),0 0 40px rgba(0,255,255,0.3);
}
...
box-shadow:0 0 10px cyan,0 0 25px rgba(0,255,255,0.4);
}
...
box-shadow:0 0 15px cyan,0 0 40px rgba(0,255,255,0.4);
}
...
box-shadow:0 0 15px rgba(255,215,0,0.7),0 0 35px rgba(255,215,0,0.4);
...
50% {
box-shadow:0 0 25px rgba(255,215,0,1),0 0 55px rgba(255,215,0,0.7);
}
}
...
<div class="left-side">
<img src="<?= e($user['photo']) ?>" class="profile-img">
...
<div class="skill-item"><?= e($skill) ?></div>
<?php } ?>
</div>
</div>
<div class="stand"></div>
...
<span class="role"><?= e($ex['role']) ?></span>
</div>

<div class="log-body">
<p><span class="label">COMPANY:</span> <?= e($ex['company']) ?></p>
<p><span class="label">DURATION:</span> <?= e($ex['duration']) ?></p>
...
<div class="edu-card">
<h3><?= e($e['degree']) ?></h3>
<p class="edu-inst"><?= e($e['institute']) ?></p>

<div class="edu-meta">
<span><?= e($e['duration']) ?></span>
<span class="score"><?= e($e['score']) ?></span>
</div>
...
<a href="<?= e($user['github']) ?>" target="_blank" rel="noopener noreferrer">
<i class="fab fa-github"></i>
</a>

<a href="<?= e($user['linkedin']) ?>" target="_blank" rel="noopener noreferrer">
